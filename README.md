...
[![Windows Build](https://github.com/upupming/vcpkg-manifest-version-bug/actions/workflows/windows.yml/badge.svg)](https://github.com/upupming/vcpkg-manifest-version-bug/actions/workflows/windows.yml)
...
```bash
git clone --recurse-submodules https://github.com/upupming/vcpkg-manifest-version-bug.git
```
...
4. Global search `vcpkg-manifest-version-bug`, `C:/Qt/5.15.2/msvc2019_64` and `Microsoft Visual Studio/2019/Community` etc., ans replace them according your own condition.
